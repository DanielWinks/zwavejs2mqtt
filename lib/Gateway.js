 ...
 *
 * @param {import('../types').HassDevice} cfg
 * @param {string} getTopic
 * @param {string} setTopic
 * @param {import('../types').Z2MNode} node
...
Gateway.prototype.prepareDiscovery = function (cfg, getTopic, setTopic, node, nodeName, valueId, vId) {
            ...
            cfg.object_id = utils.joinProps(
              ...
              switch (state.text) {
                case 'KeyPressed':
                  ...
                  trigger_payload = '{{ value_json.value == ' + state.value + ' }}'
                  break
                case 'KeyReleased':
              ...
              cfg.discovery_payload.type = trigger_type
              cfg.discovery_payload.subtype = valueId.propertyKey
              cfg.discovery_payload.payload = trigger_payload
              this.prepareDiscovery(cfg, getTopic, setTopic, node, nodeName, valueId, vId)
          }
        }
        return
