        ...
        if (valueId.hasOwnProperty('states') && valueId.property === 'scene') {
          for (const state of valueId.states) {
            ...
            cfg.object_id = utils.joinProps(
              ...
              publishDiscovery(cfg, getTopic, setTopic, node, nodeName, valueId, vId)
          }
        }
        return
 ...
 *
 */
Gateway.prototype.publishDiscovery = function (cfg, getTopic, setTopic, node, nodeName, valueId, vId) {
